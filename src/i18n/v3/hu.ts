export const hu = {
  ...
  contact: {
    ...
    items: [
      { icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z', label: '1126 Budapest, Dolgos utca 2. – 6B lépcsőház', href: 'https://maps.app.goo.gl/kZ2HKbYtLq6AtfQSA' },
